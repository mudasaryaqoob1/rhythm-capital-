...
const columns: TableProps<DataType>["columns"] = [
  {
    ...
    key: "Account",
    render: (text) => (
      <a className="font-semibold font-urbanist text-[10px] md:text-[14px] leading-[20px] text-[solid]">
        {text}
      </a>
    ),
  },
  ...
  },
  {
    ...
    render: (_, record) => (
      <Space size="middle">
        <a className=" border-[1px] rounded-full bg-[#ECFDF3] text-[#1C7731] border-[#ABEFC6] px-2 py-[2px]">
          Active
        </a>
      </Space>
    ),
